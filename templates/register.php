        ...
        <form method="post" action="/register" class="auth-form" novalidate>
            <div class="form-grid">
                <div class="form-field">
                    ...
                    <input type="text" id="username" name="username" required placeholder="Pick a unique username">
                </div>
                <div class="form-field">
                ...
                <div class="form-field">
                    ...
                    <input type="tel" id="mobile_number" name="mobile_number" placeholder="e.g. +65 8123 4567">
                </div>
                <div class="form-field">
                    <label for="country_of_origin">Country of Origin</label>
                    <input type="text" id="country_of_origin" name="country_of_origin" placeholder="e.g. Singapore">
                </div>
            </div>
